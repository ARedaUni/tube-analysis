...
export default function ContributorInsights() {
  ...
  const SkeletonLayout = () => (
    <div className="space-y-6 p-4">
      ...
      <Card>
        <CardContent className="p-4">
          <Skeleton className="h-8 w-full mb-4 animate-pulse" />
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="w-1/2"><Skeleton className="h-4 w-full animate-pulse" /></TableHead>
                <TableHead className="w-1/2 text-right"><Skeleton className="h-4 w-full animate-pulse" /></TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              {[...Array(5)].map((_, index) => (
                <TableRow key={index}>
                  ...
                  <TableCell className="text-right"><Skeleton className="h-4 w-1/2 ml-auto animate-pulse" /></TableCell>
                </TableRow>
              ))}
            </TableBody>
          </Table>
